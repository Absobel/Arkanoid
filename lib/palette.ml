...
(** [edge_coord] retourne les coordonnées du rectangle de la palette mais float
    ...
    @return
      les coordonnées du coin inférieur gauche et supérieur droit du rectangle de la palette en float *)
...
(** [edge_coord] retourne les coordonnées du rectangle de la palette mais int
    @param mouse_x la position de la souris
    @return
      les coordonnées du coin inférieur gauche et supérieur droit du rectangle de la palette en int *)
